...
public class MainActivity extends AppCompatActivity {
    ...
    public void nextClicked(View v){
        ...
        for (Question q : currentQuestions.getQuestions()){

            questionManager.setQuestionResponseWithQuestionView(q, questionRecycler.findViewHolderForAdapterPosition());
        }
        questionManager
                .loadNextQuestions()
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private SingleObserver<QuestionPage> questionMaybeObserver = new SingleObserver<QuestionPage>() {
        ...
        public void onSuccess(QuestionPage questionPage) {
            ...
            questionListAdapter.updateQuestionList(questionPage.getQuestions());
